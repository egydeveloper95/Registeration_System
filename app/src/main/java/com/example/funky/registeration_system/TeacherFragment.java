...
public class TeacherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button listteacher=(android.widget.Button)view.findViewById(R.id.listTeacher);
        listteacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),listTeacher.class));
                getActivity().finish();

            }
        });

        Button AddTeacher=(android.widget.Button)view.findViewById(R.id.AddTeacher);
