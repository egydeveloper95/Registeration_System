                    ...
                    mDatabase.getReference("User").child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(type.equals("Student"))
                                startActivity(new Intent(RegisterationActivity.this, StudentActivity.class));
                            else if (type.equals("Teacher"))
                                startActivity(new Intent(RegisterationActivity.this, AdminActivity.class));
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               if (mEmailView.getText().toString().trim().equals("")) {
                   ...
                   /*
                   *
                   *  Function Name : Create User with Email And Password
